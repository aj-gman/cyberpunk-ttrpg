...
[^24]: In specific situations, like Grafted Muscle & Bone Lace, Cyberware instead substracts its Quality from the user's [[Rules/CPRED/Cyberware/Humanity\|Humanity]] when installed, permanently. Cyberware that behaves like this usually offers "passive" bonuses.
